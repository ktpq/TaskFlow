...
export default function LoginPage() {
  ...
  return (
    ...
    <main className='w-[19vw] max-lg:w-[70vw] max-md:w-[100vw]' data-aos="fade-up" data-aos-duration="1000">
        ...
        <section className='mt-5 px-10 py-10 bg-white shadow-lg rounded-xl'>
            <h2 className='text-2xl font-bold text-[#212839] mb-5 text-shadow-black'> Welcome Back </h2>
            ...
            <input type="text" className='border-gray-300 border block w-full py-2.5 px-4 mt-1 rounded-xl text-[12px]' placeholder='********'/>

            <a href="/team">
              <button className='w-full my-4 py-3 text-sm shadow-md rounded-2xl gradient text-white font-medium hover:shadow-lg duration-300 hover:-translate-y-0.5'> Sign in </button>
            </a>
            <p className='text-center'> Don't have an account? <a href="/register" className='text-blue-500 hover:text-blue-700 duration-200'> Sign up </a> </p> 
        </section>
    </main>
    </div>
  )
